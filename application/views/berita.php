    ...
    <ul class="list-unstyled">
      <li class="media">
        ...
        <div class="media-body">
          <a href="<?php echo base_url(); ?>rumah/artikel01"><h5 class="mt-0 mb-1">Daftar Harga Motor Sport 150 cc Juni 2019</h5></a>
      ...
      <li class="media my-4">
        ...
        <div class="media-body">
          <a href="#"><h5 class="mt-0 mb-1">Adu Spek Suzuki Burgman Street 125 vs Yamaha Lexi</h5></a>
      ...
      <li class="media">
        ...
        <div class="media-body">
          <a href="#"><h5 class="mt-0 mb-1">Rossi Tak Pasang Target Muluk di GP Catalunya</h5></a>
          <p align="justify">putaran ketujuh atau GP Catalunya akan digelar akhir pekan ini. Valentino Rossi yang kesulitan di GP Italia, tak memasang terget muluk 
