    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="col-sm text-center">
              <img src="<?php echo base_url() ?>asset/gambar/katalog/suzuki/matic.png" 
              width="400px" height="400px" class="img-fluid rounded" alt="matic">
            </div>
            <div class="col-sm">
              <table class="table table-bordered" align="center">
                ...
                <tr>
                    ...
                    <td align="center"><?php include 'application/views/katalog/suzuki_matic_modal.php'; ?></td>
                </tr>
                    <?php endforeach; ?>
              </table>
            </div>
