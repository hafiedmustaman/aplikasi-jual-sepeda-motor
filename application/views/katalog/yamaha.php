        ...
        <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-sm text-center">
                    <a href="#"><img src="<?php echo base_url() ?>asset/gambar/katalog/yamaha/sport.png" 
                    width="200px" height="200px" class="img-fluid rounded" alt="SPORT"><b>SPORT</b></a>
                </div>
                <div class="col-sm text-center">
                    <a href="#"><img src="<?php echo base_url() ?>asset/gambar/katalog/yamaha/matic.png" 
                    width="200px" height="200px" class="img-fluid rounded" alt="MATIC"><b>MATIC</b></a>
                </div>
                <div class="col-sm text-center">
                    <a href="#"><img src="<?php echo base_url() ?>asset/gambar/katalog/yamaha/bebek.png" 
