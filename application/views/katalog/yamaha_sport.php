    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="col-sm text-center">
              <img src="<?php echo base_url() ?>asset/gambar/katalog/yamaha/sport.png" 
              width="400px" height="400px" class="img-fluid rounded" alt="sport">
            </div>
            <div class="col-sm">
              <table class="table table-bordered" align="center">
                ...
                <tr>
                    ...
                    <td align="center"><?php include 'application/views/katalog/yamaha_sport_modal.php'; ?></td>
                </tr>
                    <?php endforeach; ?>
              </table>
            </div>
