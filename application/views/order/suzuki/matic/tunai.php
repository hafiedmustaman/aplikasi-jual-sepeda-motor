        ...
        <div class="col-md-8">
            ...
            <div class="accordion" id="accordionExample">
                <div class="card">
                    ...
                    <div class="card-body">
                    <?php include 'application/views/order/suzuki/matic/form_cod.php'; ?>
                    </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                    <?php include 'application/views/order/suzuki/matic/form_langsung.php'; ?>
                    </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                    <?php include 'application/views/order/suzuki/matic/form_transfer.php'; ?>
                    </div>
                    </div>
                </div>
            </div>
