<form action="<?php echo base_url() ?>rumah/kredit_aksi_tambah" method="post" class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        <select class="form-control" name="formId_kredit" id="exampleFormControlSelect1" required>
            <option></option>
            <option value="k0019">k0019</option>
            <option value="k0020">k0020</option>
            <option value="k0021">k0021</option>
            <option value="k0046">k0046</option>
            <option value="k0047">k0047</option>
            <option value="k0048">k0048</option>
    </select>
    </div>
    <div class="form-group col-md-6">
