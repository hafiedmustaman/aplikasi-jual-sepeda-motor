<form action="<?php echo base_url() ?>rumah/kredit_aksi_tambah" method="post" class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        <select class="form-control" name="formId_kredit" id="exampleFormControlSelect1" required>
            <option></option>
            <option value="k0025">k0025</option>
            <option value="k0026">k0026</option>
            <option value="k0027">k0027</option>
            <option value="k0052">k0052</option>
            <option value="k0053">k0053</option>
            <option value="k0054">k0054</option>
    </select>
    </div>
    <div class="form-group col-md-6">
