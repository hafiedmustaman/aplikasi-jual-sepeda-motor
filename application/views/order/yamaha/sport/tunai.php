        ...
        <div class="col-md-8">
            ...
            <div class="accordion" id="accordionExample">
                <div class="card">
                    ...
                    <div class="card-body">
                    <?php include 'application/views/order/yamaha/sport/form_cod.php'; ?>
                    </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                    <?php include 'application/views/order/yamaha/sport/form_langsung.php'; ?>
                    </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                    <?php include 'application/views/order/yamaha/sport/form_transfer.php'; ?>
                    </div>
                    </div>
                </div>
            </div>
