<form action="<?php echo base_url() ?>rumah/langsung_aksi_tambah" method="post" class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="exampleFormControlInput1" name="formId_barang" value="b0005" readonly>
    </div> 
    <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="exampleFormControlInput1" name="formPilihan_pembayaran" value="langsung" readonly>
    </div>
    <div class="form-group col-md-6">
